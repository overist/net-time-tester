import { SystemAdminGuard } from './../../common/guard/system-admin.guard'
...
export class GlobalController {
  ...
  async saveGlobal(
    ...
    // 액션 저장
    await this.actionService.saveAdminAction(session.userId, 'saveGlobal', dto)
